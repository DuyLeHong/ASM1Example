    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (sUserName.equals("")) {
                    Toast.makeText(RegisterActivity.this, "Username khong duoc de trong!", Toast.LENGTH_SHORT).show();
                } else if (sPassword.equals("")) {
                    Toast.makeText(RegisterActivity.this, "Password khong duoc de trong!", Toast.LENGTH_SHORT).show();
